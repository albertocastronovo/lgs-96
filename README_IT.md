...
- Un badge colorato su ogni card mostra le informazioni sulla retribuzione nel testo dell'inserzione:
  ...
  - :white_circle: grigio: l'estensione sta ancora processando la descrizione o non ha potuto verificare le informazioni sulla retribuzione a causa di un errore.
...
Per proporre il supporto di una nuova lingua, compila un file YAML nella cartella `extension/localization/`.  
Per migliorare il funzionamento dell'estensione, aggiungi alcune frasi degli annunci di lavoro nella tua lingua in coda al file `train/salary.json`, indicando un estratto del testo e i risultati attesi.
